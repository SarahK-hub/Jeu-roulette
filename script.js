...
(function () {
  ...
  const spinBtn = document.getElementById("spin");
   ...
   const rater = new Audio("./8-bit-video-game-fail-version-2-145478.mp3");
  const gain = new Audio("./11l-victory_trumpet-1749704469779-358762.mp3");
  const slot = new Audio("./slot-machine-payout-81725.mp3");
  const victoire = new Audio("./winning-218995.mp3");
